...
//   switch (type) {
//     case "warn":
//       process.stderr.write(gradient.cristal(`\r[ WARNING ] > ${text}`) + '\n');
//       break;
//     case "error":
//       process.stderr.write(chalk.red.bold(`\r[ ERROR ] > ${text}`) + '\n');
//       break;
//     default:
//       process.stderr.write(gradient.cristal(`\r${String(type).toUpperCase()} > ${text}`) + '\n');
//       break;
//   }
// };
...
//   switch (option) {
//     case "warn":
//       console.log(gradient.cristal("[ WARNING ] > ") + gradient.cristal(data));
//       break;
//     case "error":
//       console.log(chalk.red.bold("[ ERROR ] > ") + chalk.red.bold(data));
//       break;
//     default:
//       console.log(gradient.cristal("[ LOADING ] > ") + gradient.cristal(data));
//       break;
//   }
// };
